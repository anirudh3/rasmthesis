...
class FeatureData:
    ...
    dir_trainfolder = "/home/ubuntu/thesis_related/data/fma_small_consolidated/fma_small_consolidated"
...
#             print("Extracted features audio track %i of %i." % (i + 1, len(list_of_audiofiles)))
            ...
            #except e:
            #    print "error reading.....continuing", e
            #    continue
...
#song_features.load_deserialize_data()
#print "data:", song_features.train_X
